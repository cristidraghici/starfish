...
class textdb
{
	...
	{
		return obj('encrypt')->safe_b64encode( $this->connection['encrypt']->encode( $this->connection['scramble']->encode($string) ) );
	...
	{
		return $this->connection['scramble']->decode( $this->connection['encrypt']->decode( obj('encrypt')->safe_b64decode($string) ) );
