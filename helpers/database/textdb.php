...
class textdb
{
    ...
    function connect($config)
    {
        ...
        {
            $scramble = starfish::access('scramble');
            $encrypt  = starfish::access('encrypt');
    ...
    {
        $string = obj('encrypt')->safe_b64encode( $string );
        $string = $this->connection['encrypt']->encode( $string );
        $string = $this->connection['scramble']->encode( $string );
