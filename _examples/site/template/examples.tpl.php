                ...
                <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 portfolio-item">
                                ...
                                <div class="portfolio-caption">
                                        <h4>Post-it Notes</h4>
                                        <p class="text-muted">Starfish, jQuery, Bootstrap</p>
                                </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 portfolio-item">
                                ...
                                <div class="portfolio-caption">
                                        <h4>SQL Query</h4>
                                        <p class="text-muted">Starfish, MySQL</p>
                                </div>
                        </div>
                        ...
                        <div class="modal-content">
                                ...
                                <div class="col-lg-8 col-lg-offset-2">
                                        <div class="modal-body">
                                                ...
                                                <img class="img-responsive" src="public/images/example.jpg" alt="">
